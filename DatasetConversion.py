...
if __name__ == '__main__':
    ...
    task_name = 'Task666_Advanced_AI_Project'
    ...
    # labels
    labels_dir_tr = join(base, 'train', 'mask')
    images_dir_tr = join(base, 'train', 'img')
    ...
    labels_dir_ts = join(base, 'test', 'mask')
    images_dir_ts = join(base, 'test', 'img')
    ...
    generate_dataset_json(join(target_base, 'dataset.json'), target_imagesTr, target_imagesTs, ('CT',),
                          labels={0: 'background', 1: 'Angiomas'}, dataset_name=task_name, license='hands off!')
